...
The vignette
[Introducing revdbayes](https://cran.r-project.org/web/packages/revdbayes/vignettes/revdbayes-vignette.html) covers the sampling from extreme value posterior distributions.
...
`portpirie` and `gom` datasets that feature in the vignette [Introducing revdbayes](https://cran.r-project.org/web/packages/revdbayes/vignettes/revdbayes-vignette.html).
...
[Graphical posterior predictive checks](https://cran.r-project.org/web/packages/bayesplot/vignettes/PPC.html).  *bayesplot* functions return a `ggplot` object 
...
```{r, fig.show='hold', fig.width = 3.45}
# GEV
